<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="nick" label="店铺名称" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="商品名称" prop="deptName">
              <el-input v-model="form.deptName" placeholder="请输入商品名称" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
<script>
import { taskList, getDept, delTask, addDept, updateDept, listDeptExcludeChild } from '@/api/system/goods'
...
export default {
  ...
  methods: {
    ...
    /** 删除按钮操作 */
    handleDelete(row) {
      this.$modal.confirm('是否确认删除商品为"' + row.title + '"记录？').then(function() {
        return delTask(row.goodsId)
      }).then(() => {
        this.getList()
