        ...
        <el-form ref="queryForm" :model="queryParams" size="small" :inline="false">
          <el-form-item label="商品地址" prop="deptName">
            <el-input
              ...
              type="textarea"
              :rows="12"
              placeholder="请输入要复制的url地址（格式如下），一行一个连接地址最多支持100行，目前支持【天猫】【淘宝】【1688】，如：
    ...
    <div v-show="step==2">
      <el-card>
        ...
        <div class="el-table el-table--enable-row-hover el-table--medium">
          <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="150px" size="mini" class="demo-ruleForm">
            ...
            <el-form-item label="商品分类" prop="category">
              ...
              <el-select v-model="ruleForm.category1" style="margin-left:5px" filterable placeholder="请选择" @change="categoryChange1">
                <el-option
              ...
              <el-select v-model="ruleForm.category2" style="margin-left:5px" filterable placeholder="请选择" @change="categoryChange2">
                <el-option
              ...
              <el-select v-model="ruleForm.category3" style="margin-left:5px" filterable placeholder="请选择" @change="categoryChange3">
                <el-option
