    ...
    if (!isRelogin.show) {
      ...
      MessageBox.confirm('登录状态已过期，您可以继续留在该页面，或者重新登录', '系统提示', {
        ...
        store.dispatch('LogOut').then(() => {
          ...
          // location.href = `https://fuwu.pinduoduo.com/service-market/auth?response_type=code&client_id=${process.env.VUE_APP_CLIENT_ID}&redirect_uri=${process.env.VUE_APP_REDIRECT_URI}`
        })
      }).catch(() => {
        isRelogin.show = false
      })
